...
public class TableDataUtils {
	 ...
	 * @param categoryList The array containing categories that need to be displayed in the table.
	...
	/**
	 * Method to get the table headers for category. It is important that this is in sync with the content method.
	 ...
	 * @param productList The array containing products that need to be displayed in the table.
	 * @return The 2D string array which will be input to the table.
	 */
	...
	/**
	 * Method to get the table headers for product. It is important that this is in sync with the content method.
	 * @return The string array with the table headers. 
	 */
	public static String[] getHeadersForProductTable() {
		String[] list = new String[]{ Constants.TableData.STR_PRODUCT_NAME,Constants.TableData.STR_PRODUCT_DESCRIPTION, 
				Constants.TableData.STR_PRODUCT_QUANTITY, Constants.TableData.STR_PRODUCT_PRICE, Constants.TableData.STR_PRODUCT_REORDER_THRESHOLD, 
	 ...
	 * @param productList The array containing discounts that need to be displayed in the table.
	 * @return The 2D string array which will be input to the table.
	 */
	public static String[][] getFormattedDiscountListForTable(ArrayList<Discount> discountList) {
		...
		for (int row = 0; row < discountList.size(); row++) {
			Discount discount = discountList.get(row);
		     ...
		     list[row][Constants.TableData.SIXTH_COLUMN] = String.valueOf(discount.getEligibilty());
		 }
		return list;
	}
	
	/**
	 * Method to get the table headers for discount. It is important that this is in sync with the content method.
	 * @return The string array with the table headers. 
	 */
	public static String[] getHeadersForDiscountTable() {
		String[] list = new String[]{ Constants.TableData.STR_DISCOUNT_CODE,Constants.TableData.STR_DISCOUNT_DESCRIPTION, 
				Constants.TableData.STR_DISCOUNT_START_DATE, Constants.TableData.STR_DISCOUNT_PERIOD, Constants.TableData.STR_DISCOUNT_PERCENTAGE, 
	...
	/**
	 * Method to get the table headers for member. It is important that this is in sync with the content method.
	 * @return The string array with the table headers. 
	 */
